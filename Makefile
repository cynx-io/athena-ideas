...
build_and_push:
	docker build -t athena-ideas-dev:latest .
	docker tag athena-ideas-dev:latest derwin334/athena-ideas-dev:latest
	docker push derwin334/athena-ideas-dev:latest
